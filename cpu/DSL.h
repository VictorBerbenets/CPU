...
#define Push_ram_reg()        StackPush(&my_cpu->stack_cpu, my_cpu->ram[(int)my_cpu->cpu_registers[(int) my_cpu->data[*number]]])
...
#define Pop_to_ram_number()   my_cpu->ram [*(int*)(my_cpu->data + *number)]      = StackPop(&my_cpu->stack_cpu)
#define Pop_to_ram_reg()      my_cpu->ram [(int)my_cpu->cpu_registers[(int) my_cpu->data[*number]]] = StackPop(&my_cpu->stack_cpu)
